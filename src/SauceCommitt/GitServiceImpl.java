...
public class GitServiceImpl extends AbstractOpenEngSBConnectorService implements ScmDomain { 
    ...
    private void prepareWorkspace() { 
        if (localWorkspace == null) { 
            throw new Exception("Local workspace not set."); 
        } 
    ...
    private void tryCreateLocalWorkspace() { 
        ...
        if (!localWorkspace.exists()) { 
            throw new Exception("Local workspace directory '" + localWorkspace 
                    + "' does not exist and cannot be created."); 
        } 
        if (!localWorkspace.isDirectory()) { 
            throw new Exception("Local workspace directory '" + localWorkspace + "' is not a valid directory."); 
        } 
    } 
    ...
    private void initRepository() throws IOException { 
        ...
        repository = (FileRepository) builder.build(); 
    ...
    public CommitRef getCommitRefForTag(TagRef ref) { 
        try { 
            ...
            if (revTag.getObject() instanceof RevCommit) { 
                commitRef = new GitCommand((RevCommit) revTag.getObject()); 
